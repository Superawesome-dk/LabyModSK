...
public class EffAddWidget extends Effect {
    static {
        Skript.registerEffect(EffAddWidget.class,
                ...
                "[LabyModSK] add color picker widget with id %integer%[ and anchorX %-double% and anchorY %-double%] and offsetX %double% and offsetY %double% and width %integer% and height %integer% and title %string% and color %labymodskjavacolor%[ and use rgb %-boolean%] to [widgets of] %labymodskjsonobject%",
