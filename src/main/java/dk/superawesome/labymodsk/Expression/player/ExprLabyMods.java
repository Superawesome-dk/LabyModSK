...
public class ExprLabyMods extends SimpleExpression<String> {
    ...
    protected String[] get(Event event) {
        ...
        if(LabyPlayer.isPresent()) {
            List<ModificationExtension> mods = LabyPlayer.get().getModifications();
            for (ModificationExtension mod : mods) {
